	...
	class EasyImage
	{
		public:
            ...
            */
            ...
            void draw_zbuf_triag(ZBuffer &buffer, const Triangle &t, const double &d, const double &dx, const double &dy,
                                  const ini::DoubleTuple& ambientReflection, const ini::DoubleTuple& diffuseReflection, const ini::DoubleTuple& specularReflection, double reflectionCoeff, std::vector<Light*> &lights);
